  ...
  return (
    <div className="relative w-full h-full min-h-screen sm:min-h-[100vh] mx-auto px-4 md:px-8 lg:px-16 py-14 md:py-48 lg:py-60 flex flex-col justify-center z-0 overflow-clip">
      ...
      >
        ...
        {/* Mobile: Only show middle ring with zoom effect */}
        <div className="sm:hidden absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-[1.5]">
          <div className="size-[620px] hero-ring"></div>
          
          {/* Keep only the inner orbits that would be visible with the middle ring */}
          <HeroOrbit
            size={430}
            rotation={-15}
            shouldOrbit
        ...
        {/* Desktop: Show all rings normally */}
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center">
          <div className=" text-3xl md:text-5xl text-center bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text">
            GAYATHRI GALIVEETI
          </div>
          <div>
